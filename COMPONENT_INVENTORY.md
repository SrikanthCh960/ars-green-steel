...
| `BlogArticleTemplate` | `src/components/blog-article-template.tsx` | Shared long-form article shell for migrated ARS blog posts | Uses a wide two-column desktop reading layout with a 280px white, numbered sticky page-index card with a subtle border, a native mobile “On this page” disclosure, article-owned quick takeaway, category-specific post-reading CTA, related articles, and the shared final contact band | All `/blog/[slug]` articles |
