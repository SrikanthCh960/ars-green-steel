...
| `QualityDocumentGallery` | `src/components/quality-document-gallery.tsx` | Horizontally scrollable quality and certification document gallery | Compact certificate-preview cards with a native, keyboard-accessible enlargement dialog | `/our-quality` |
