...
| `PageHero` | `src/components/page-sections.tsx` | Shared editorial interior-page hero with eyebrow, H1, paragraph, and actions | Uses the `/about-us` reference composition: red-rule eyebrow above the H1, one readable content column, consistent paragraph width, and horizontal actions; supports video/image backgrounds and an optional accent title line | Multiple pages |
