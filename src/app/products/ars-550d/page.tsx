...
const productPageJsonLd = createProductPageWebPageJsonLd({
  path: "/product-550d",
  name: "ARS Fe 550D TMT Bars | ARS Group",
  description:
    "ARS Fe 550D high-strength ductile TMT bars (Fe-550D, IS 1786:2008) for safer residential, commercial, and infrastructure construction.",
  image: "/ars-assets/products/ARS550DBanner.jpg",
});
      ...
      <MotionSection className="bg-white py-20 md:py-24" id="specifications">
        <div className="ars-container grid gap-14 lg:grid-cols-2 lg:items-stretch lg:gap-16">
          ...
          <div className="overflow-hidden rounded-2xl border-[1.5px] border-surface-100">
            ...
            <div className="border-t border-surface-100 bg-white p-5"><a href="/ars-assets/Downloads/ars-fe-550d-brochure.pdf" download className="focus-ring inline-flex items-center gap-2 rounded-full border border-brand-blue/20 px-4 py-2 text-[13px] font-bold text-brand-blue transition hover:border-brand-blue hover:bg-brand-blue hover:text-white"><Download size={14} aria-hidden="true" /> Download Brochure</a></div>
          </div>
        </div>
      </MotionSection>
