...
const specs = [
  ...
  ["Proof available", "Physical properties, chemical properties, bend/rebend, tensile, and lab test context"],
    ...
    >
      <ProofMetrics
        metrics={[
          ...
          { kicker: "quality", value: "SGS", label: "Certification and testing proof supports product decisions." },
      ...
      <MotionSection className="bg-white py-24" id="specifications">
        <div className="ars-container">
          <SectionIntro
            ...
            body="Review the grade, use cases, proof path, and next steps before moving into price or quote support."
          />
      ...
      <ContentBand
        ...
        cards={[
          ...
          { title: "Proof path", text: "Physical properties, chemical properties, FAQs, and test context help technical buyers review the grade.", icon: ClipboardList },
        ]}
      />
      ...
      <ContentBand
        ...
        cards={[
          ...
          { title: "Find dealer", text: "Route to ARS dealer and local supply support.", href: "/dealer-locator", icon: BadgeCheck },
