...
const sellingActions = [
  { icon: <IndianRupee size={20} />, title: "Check Price", desc: "View the latest ARS CRS 550D TMT Bar price before planning your project.", cta: "View Price →", href: "/tmt-steel-price-today" },
  ...
  { icon: <GitCompare size={20} />, title: "Compare ARS 550D", desc: "Compare ARS CRS 550D and ARS 550D to select the right reinforcement steel based on your project environment.", cta: "Compare Grades →", href: "/product-550d" },
];
    ...
    <main className="min-h-screen overflow-x-clip bg-surface-50 text-ink-900">
      ...
      <section className="ars-page-hero relative flex min-h-[560px] items-end overflow-hidden bg-ink-950 md:min-h-[600px] lg:h-[680px] lg:min-h-[680px]">
        <div className="absolute inset-0">
          <Image src="/ars-assets/products/ArsCRS550D.jpg" alt="ARS CRS 550D TMT bars with campaign spokesperson" fill priority sizes="100vw" className="object-cover object-[60%_center]" />
        ...
        <div className="ars-container relative z-10 w-full pb-14 pt-36 md:pb-20">
          <div className="max-w-4xl">
            <div className="mb-7 flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.18em] text-white/70"><span className="h-px w-10 bg-brand-red" aria-hidden="true" />ARS CRS 550D TMT Bars | Corrosion Resistant Fe 550D Reinforcement Steel</div>
            ...
            <p className="mt-7 max-w-2xl text-base leading-7 text-white/75 md:text-lg md:leading-8">Engineered for high-salinity, humid, and demanding environments, ARS CRS 550D combines superior corrosion resistance with high strength and ductility for durable reinforced concrete construction.</p>
      ...
      <ProductLeadCaptureForm product="ARS CRS 550D" trustItems={["BIS-certified", "SGS-tested", "CRS 550D", "30+ years"]} showCallSales={false} />
      ...
      <MotionSection className="relative overflow-hidden bg-brand-blue py-20"><div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(circle at 15% 50%, rgba(222,18,26,0.7) 0%, transparent 55%)" }} /><div className="ars-container relative z-10"><SectionKicker variant="light">READY TO BUILD</SectionKicker><h2 className="mt-5 font-display text-[clamp(2rem,3.4vw,2.25rem)] font-bold leading-[1.12] tracking-[-0.02em] text-white">Choose ARS CRS 550D for Long-Term Structural Protection</h2><p className="mt-3 max-w-[540px] text-[14px] leading-[1.7] text-white/75">Get a Quote for ARS 550D</p></div></MotionSection>
    </main>
  );
}
