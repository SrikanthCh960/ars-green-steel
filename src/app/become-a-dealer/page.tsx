    ...
    <main id="main-content" className="min-h-screen overflow-x-clip bg-white text-ink-900">
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="ars-container grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:gap-20">
          <div><SectionKicker>PRODUCT RANGE</SectionKicker><h2 className="mt-6 font-display text-[clamp(2rem,3.4vw,2.25rem)] font-bold leading-[1.1]">Products your customers can trust.</h2><p className="mt-5 max-w-2xl text-base leading-8 text-steel-700">Explore the ARS range and choose the right route for your product conversations.</p><div className="mt-8 flex flex-wrap gap-3"><Link href="/product-550d" className="focus-ring inline-flex min-h-11 items-center gap-2 bg-brand-blue px-5 text-sm font-bold text-white">ARS 550D <ArrowRight size={16} aria-hidden="true" /></Link><Link href="/product-crs-550d" className="focus-ring inline-flex min-h-11 items-center gap-2 border border-brand-blue/25 px-5 text-sm font-bold text-brand-blue">CRS 550D <ArrowRight size={16} aria-hidden="true" /></Link><Link href="/ars-binders" className="focus-ring inline-flex min-h-11 items-center gap-2 border border-brand-blue/25 px-5 text-sm font-bold text-brand-blue">ARS Binders <ArrowRight size={16} aria-hidden="true" /></Link></div></div>
