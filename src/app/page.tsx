  ...
  return (
    <MotionSection className="relative overflow-hidden bg-bg-dark py-24 text-white" id="ars-green-steel">
      ...
      <div className="ars-container relative z-10">
        ...
        <div className="mt-8 grid overflow-hidden rounded-[12px] border border-white/15 bg-white/[0.06] divide-y divide-white/12 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
          {["GreenPro Certified", "GRIHA", "EPD Documented", "SGS Tested"].map((item) => (
            <div key={item} className="flex min-h-16 items-center justify-center px-4 py-4 text-center font-technical text-[11px] font-bold uppercase tracking-[0.14em] text-emerald-100">
              <span>{item}</span>
            </div>
          ))}
        </div>
    ...
    <MotionSection className="overflow-hidden bg-white py-20 lg:py-28" id="manufacturing-story">
      <div className="ars-container">
        <div className="grid items-center gap-12 lg:grid-cols-[0.94fr_1.06fr] lg:gap-16">
          <div className="relative min-h-[420px] overflow-hidden rounded-[20px] bg-transparent shadow-[var(--shadow-soft)] sm:min-h-[540px]">
            <Image
