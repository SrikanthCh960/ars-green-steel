  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-surface-50 text-ink-900">
      ...
      <MotionSection className="bg-bg-dark py-20 text-white md:py-28">
        <div className="ars-container"><SectionKicker variant="light">ARS Products</SectionKicker><div className="grid gap-8 lg:grid-cols-[0.48fr_0.52fr] lg:items-end"><h2 className="section-title section-title-light">TMT Bars Built for Bridge &amp; Infrastructure Construction</h2><p className="text-[15px] leading-7 text-white/70">Choose the right reinforcement solution based on structural requirements, environmental conditions, and long-term durability for bridge and infrastructure projects.</p></div><div className="mt-12 overflow-x-auto border border-white/16"><table className="min-w-[680px] w-full text-left"><caption className="sr-only">Comparison of CRS 550D and ARS Fe550D TMT Bars for bridge and infrastructure construction</caption><thead className="bg-white/10 text-sm"><tr><th scope="col" className="p-5 font-technical uppercase tracking-[0.14em] text-white/65">Feature</th><th scope="col" className="p-5 font-display text-lg text-white">ARS CRS 550D</th><th scope="col" className="p-5 font-display text-lg text-white">ARS Fe550D</th></tr></thead><tbody>{productRows.map(([feature, crs, fe550d]) => <tr key={feature} className="border-t border-white/12"><th scope="row" className="p-5 text-sm font-bold text-white">{feature}</th><td className="p-5 text-sm leading-6 text-white/72">{crs}</td><td className="p-5 text-sm leading-6 text-white/72">{fe550d}</td></tr>)}</tbody></table></div><div className="mt-7 flex flex-wrap gap-4"><Link href="/product-crs-550d" className="focus-ring inline-flex min-h-12 items-center gap-2 rounded-[6px] bg-brand-red px-5 text-sm font-bold text-white shadow-[0_10px_24px_rgba(222,18,26,0.24)] transition hover:bg-brand-red-dark">Explore ARS CRS 550D <ArrowRight aria-hidden="true" size={15}/></Link><Link href="/product-550d" className="focus-ring inline-flex min-h-12 items-center gap-2 rounded-[6px] bg-brand-blue px-5 text-sm font-bold text-white shadow-[0_10px_24px_rgba(13,43,110,0.24)] transition hover:bg-brand-blue-dark">Explore ARS Fe550D <ArrowRight aria-hidden="true" size={15}/></Link></div></div>
      </MotionSection>
