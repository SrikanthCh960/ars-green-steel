...
export const metadata: Metadata = createPageMetadata({
  title: "TMT Steel Bars for Bridge Projects | Durable & Reliable | ARS Steel",
  description:
...
const productRows = [
  ...
  ["Best suited for", "Coastal, high-moisture & high salinity, high TDS infrastructure, bridge & infrastructure projects", "General construction"],
