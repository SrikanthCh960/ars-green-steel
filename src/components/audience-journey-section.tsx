...
export function AudienceJourneySection() {
  return (
    <HomepageSectionMotion className="bg-surface-50 py-20 lg:py-28" id="audiences">
      <div className="ars-container">
        <div className="mb-12 max-w-4xl">
          <HomepageReveal><SectionKicker className="mb-5">Audience Paths</SectionKicker></HomepageReveal>
            ...
            <HomepageReveal key={path.title} delay={0.26 + index * 0.07}>
              ...
              >
                <Image
                  ...
                  className="object-cover transition duration-500 group-hover:scale-[1.03] group-focus-visible:scale-[1.03] motion-reduce:transform-none motion-reduce:transition-none"
                />
