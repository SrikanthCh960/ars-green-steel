...
function HomeownerFigmaContent() {
  ...
  return <>
    ...
    <section className="bg-white py-20 lg:py-28"><div className={homeownerRail}><div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16"><div className="relative min-h-[280px] self-end overflow-hidden bg-[#F4F7FF]"><Image src="/ars-assets/blog-banners/importance-of-tds-in-steel-manufacturing/TDS-and-its-significance.jpeg" alt="TDS testing of construction water" fill sizes="(min-width: 1024px) 42vw, 100vw" className="object-cover object-[center_bottom]" /><div className="absolute inset-x-0 bottom-0 h-1 bg-brand-red" /></div><div><SectionKicker>FREE TDS TESTING</SectionKicker><h2 className={homeownerSectionTitle}>Know Your Water Before You Build.</h2><p className={homeownerSectionCopy}>ARS offers free TDS testing to help homeowners understand the water conditions at their construction site. High TDS levels can increase the risk of steel corrosion over time. Based on the test results, our team helps you choose the right TMT bars for better durability, long-term structural protection, and peace of mind.</p><Link href="/steel-testing" className="focus-ring mt-8 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-[6px] bg-brand-red px-5 text-sm font-bold text-white transition hover:bg-[#c90f16] sm:w-auto">Schedule a Free TDS Test <ArrowRight size={16} aria-hidden="true" /></Link></div></div></div></section>
    ...
    <section className="bg-[#F4F7FF] py-20 lg:py-28">
      <div className={`${homeownerRail} grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start`}>
        ...
        <LeadForm title="Plan Your Home Build with Confidence" body="Tell us what you are building and where. We will help you find the right ARS solution." intent="contact" submission="quote" />
      </div>
    </section>
  </>;
}
